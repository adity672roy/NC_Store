...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-10 py-4 px-10 flex gap-2 justify-between items-center bg-white max-sm:px-2">
      ...
      <div className="flex gap-2 border border-grey-2 px-2 py-1 items-center rounded-lg">
        <input
          className="outline-none max-sm:max-w-[70px]"
          placeholder="Search..."
          value={query}
      ...
      <div className="relative flex gap-3 items-center">
        ...
        {dropdownMenu && (
          <div className="absolute w-[150px] top-12 right-5 flex flex-col gap-4 p-3 rounded-lg border bg-white text-base-bold lg:hidden">
